    ...
    return (
        <div>
            ...
            <div className="relative overflow-hidden bg-white">
                ...
                {/* 
                <section className="p-6 dark:bg-gray-200 dark:text-gray-900">
                    <div className="container p-4 mx-auto text-center">
                        <h2 className="text-4xl font-bold">Skills</h2>
                    </div>
                    <div className="container flex flex-wrap justify-center mx-auto dark:text-yellow-500">
                ...
                {/* <section className="dark:bg-gray-800 dark:text-gray-100">
                    <div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-between">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" aria-label="HTML" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-gray-400">
                                <path fill="#E44D26" d="M19.83 113.333l-8.963-100h87.26l-8.962 100L64 120z" />
                                <path fill="#F1662A" d="M64 117.333l42.396-4.8 3.77-42.202H64V117.33z" />
                                <path fill="#EBEBEB" d="M64 51.198H36.732l-1.07-11.958H64V25.333H27.98l-.542-6.067L64 13.865l36.604 5.4L100.02 25.33H64v14.865l1.772 19.8H64v14.865h35.268l1.303 14.601H64v13.865l21.834 2.4 1.898-21.267H128v-14.866H89.496L87.92 79.198H128V64.333H87.92l-1.07-11.999z" />
                            </svg>
                        </div>
                    </div>
                </section> */}
